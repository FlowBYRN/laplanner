...
namespace TrainingsPlanner.DataAccess.Implementation
{
    public class TrainingsAppointmentRepository : ITrainigsAppointmentRepository
    {
        ...
        public TrainingsAppointmentRepository(TrainingDbContext context)
        {
            Context = context;
        }
        ...
        public async Task<TrainingsAppointment> UpdateAppointment(TrainingsAppointment trainingsAppointment)
        {
            ...
            Context.TrainingsAppointments.Update(trainingsAppointment).State = Microsoft.EntityFrameworkCore.EntityState.Modified;
