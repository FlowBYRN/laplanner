...
namespace Trainingsplanner.Postgres.Data.Migrations
{
    ...
    [Migration("20220325233336_ChangeKeyFollow")]
    partial class ChangeKeyFollow
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trainingsplanner.Postgres.Data.Models.TrainingsModuleFollow", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "TrainingsModuleId");

                    b.HasIndex("TrainingsModuleId");

                    b.ToTable("TrainingsModuleFollows", (string)null);
                });
            ...
            modelBuilder.Entity("Trainingsplanner.Postgres.Data.Models.TrainingsModule", b =>
                {
                    b.HasOne("Trainingsplanner.Postgres.Data.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
